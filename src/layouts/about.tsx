  ...
  return (
    <div id="about">
      <div className="flex flex-col items-center">
        <h3 className="text-[#000] dark:text-[#bad2ff] text-4xl font-bold ">About Me</h3>
        <div className="h-1 w-[80px] bg-[#bad2ff] mt-3"></div>
      </div>
      <div className="grid lg:grid-cols-2 sm:grid-cols-1 gap-8 px-5 mt-16">
        <div className="col-span-1">
          <h3 className="font-bold text-2xl text-[#000] dark:text-[#bad2ff]">Get to know me!</h3>
        ...
        <div className="col-span-1">
          <h3 className="font-bold text-2xl text-[#000] dark:text-[#bad2ff]">Education</h3>
          <p className="text-[#000] dark:text-[#fff] text-[18px] my-3.5">
            2019-2023
          </p>
          <h3 className="font-bold text-xl text-[#000] dark:text-[#bad2ff]">
